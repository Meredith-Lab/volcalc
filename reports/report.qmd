...
All functions have had their documentation fleshed out as well.
...
-   Allowing users to specify the environment (air or soil) for categorizing relative volatility into "low", "medium", and "high".
    This has an open [pull request](https://github.com/Meredith-Lab/volcalc/pull/76) waiting for review.
