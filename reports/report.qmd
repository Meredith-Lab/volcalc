...
-   Allowing users to specify the method of calculation as the original SIMPOL.1 method or the version modified by Meredith et al. This has an open [pull request](https://github.com/Meredith-Lab/volcalc/pull/72) waiting for review.
