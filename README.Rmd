...
Currently, the only methods implemented are SIMPOL.1 (Pankow & Asher 2008) and a modified version used in Meredith et al. (in review).
...
You can install the 'legacy' version used in our in-review publication with
