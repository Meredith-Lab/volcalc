...
#>   <chr>       <fs::path>                                                            
#> 1 C08491      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/C08491.mol
#> 2 C11512      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/C11512.mol
```
...
#>   <chr>                                                                  <chr>    <chr>            <dbl> <fct>   
#> 1 /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/C08491.mol C12H18O3 (-)-Jasmonic ac…  1.85 moderate
#> 2 /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/C11512.mol C13H20O3 Methyl jasmonate  3.82 high
```
...
#>   <chr>       <chr>    <chr>             <dbl> <fct>   
#> 1 C08491      C12H18O3 (-)-Jasmonic acid  1.85 moderate
#> 2 C11512      C13H20O3 Methyl jasmonate   3.82 high
```
...
#> Downloading ■■■■■■■■■■■■■ 40% | ETA: 2sDownloading ■■■■■■■■■■■■■■■■■■■■■■■■■ 80% | ETA: 1s
head(alam_pathway)
#> # A tibble: 6 × 3
#>   pathway_id compound_id mol_path                                                                       
#>   <chr>      <chr>       <fs::path>                                                                     
#> 1 map00592   C00157      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/map00592/C00157.mol
#> 2 map00592   C01226      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/map00592/C01226.mol
#> 3 map00592   C04672      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/map00592/C04672.mol
#> 4 map00592   C04780      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/map00592/C04780.mol
#> 5 map00592   C04785      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/map00592/C04785.mol
#> 6 map00592   C06427      /var/folders/wr/by_lst2d2fngf67mknmgf4340000gn/T/RtmpDEUw73/map00592/C06427.mol
dim(alam_pathway)
#> [1] 44  3
```
...
#>  2 map00592   C19757      C8H14O2  (3Z)-Hex-3-en-1-yl acetate  6.76 high    
#>  3 map00592   C08492      C6H12O   3-Hexenol                   6.45 high    
#>  4 map00592   C16323      C9H14O   3,6-Nonadienal              6.05 high    
#>  5 map00592   C11512      C13H20O3 Methyl jasmonate            3.82 high    
#>  6 map00592   C16318      C13H20O3 (+)-7-Isomethyljasmonate    3.82 high    
#>  7 map00592   C16322      C9H16O3  9-Oxononanoic acid          2.78 high    
#>  8 map00592   C16343      C17H28O  Heptadecatrienal            2.70 high    
#>  9 map00592   C08491      C12H18O3 (-)-Jasmonic acid           1.85 moderate
#> 10 map00592   C16317      C12H18O3 (+)-7-Isojasmonic acid      1.85 moderate
```
